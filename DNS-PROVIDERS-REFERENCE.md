...
**Family Filter (Adult Content Blocking)**
...
| Uncensored | No-filter | 91.239.100.100 | 2001:67c:28a4:: | Unrestricted |
...
2. Copy the IPv4 and IPv6 addresses
3. Open Windows Settings → Network & Internet → DNS settings
4. Click "Edit" next to DNS servers
5. Select "Manual"
6. Paste the IPv4 and IPv6 addresses
